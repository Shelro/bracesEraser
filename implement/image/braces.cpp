...
int main(){
    ...
    if( mFaceDetector.empty() )
        mFaceDetector.load( "/Users/zhangyingyi/Documents/重要文件/同济/学习/计算机视觉/FP/image/image/haarcascade_frontalface_alt2.xml" );
    ...
    mFaceDetector.detectMultiScale( img, faceVec, 1.1, 2, 0 | CV_HAAR_SCALE_IMAGE, Size(30, 30));
    int i, j;
