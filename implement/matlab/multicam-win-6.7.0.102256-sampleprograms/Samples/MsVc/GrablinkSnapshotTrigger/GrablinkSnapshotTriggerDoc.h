...
// GrablinkSnapshotTriggerDoc.h : interface of the CGrablinkSnapshotTriggerDoc class
//
/////////////////////////////////////////////////////////////////////////////
...
class CGrablinkSnapshotTriggerDoc : public CDocument
{
...
protected: // create from serialization only
    ...
    DECLARE_DYNCREATE(CGrablinkSnapshotTriggerDoc)
...
// Overrides
    ...
    //{{AFX_VIRTUAL(CGrablinkSnapshotTriggerDoc)
public:
...
// Implementation
public:
    virtual ~CGrablinkSnapshotTriggerDoc();
#ifdef _DEBUG
...
protected:
    //{{AFX_MSG(CGrablinkSnapshotTriggerDoc)
    afx_msg void OnGo();
    afx_msg void OnStop();
    //}}AFX_MSG
    DECLARE_MESSAGE_MAP()
