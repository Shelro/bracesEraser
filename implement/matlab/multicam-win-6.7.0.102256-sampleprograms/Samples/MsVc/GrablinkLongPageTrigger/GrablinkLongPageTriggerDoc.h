...
// GrablinkLongPageTriggerDoc.h : interface of the CGrablinkLongPageTriggerDoc class
//
/////////////////////////////////////////////////////////////////////////////
...
class CGrablinkLongPageTriggerDoc : public CDocument
{
...
protected: // create from serialization only
    ...
    DECLARE_DYNCREATE(CGrablinkLongPageTriggerDoc)
...
// Overrides
    ...
    //{{AFX_VIRTUAL(CGrablinkLongPageTriggerDoc)
public:
...
// Implementation
public:
    virtual ~CGrablinkLongPageTriggerDoc();
#ifdef _DEBUG
...
protected:
    //{{AFX_MSG(CGrablinkLongPageTriggerDoc)
    afx_msg void OnGo();
    afx_msg void OnStop();
    //}}AFX_MSG
    DECLARE_MESSAGE_MAP()
