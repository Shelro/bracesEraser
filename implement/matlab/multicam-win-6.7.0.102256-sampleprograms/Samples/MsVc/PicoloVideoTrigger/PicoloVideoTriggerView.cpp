...
// PicoloVideoTriggerView.cpp : implementation of the CPicoloVideoTriggerView class
//
...
/////////////////////////////////////////////////////////////////////////////
// CPicoloVideoTriggerView

IMPLEMENT_DYNCREATE(CPicoloVideoTriggerView, CView)

BEGIN_MESSAGE_MAP(CPicoloVideoTriggerView, CView)
    //{{AFX_MSG_MAP(CPicoloVideoTriggerView)
...
/////////////////////////////////////////////////////////////////////////////
// CPicoloVideoTriggerView construction/destruction

CPicoloVideoTriggerView::CPicoloVideoTriggerView()
{
    m_pMainFrame = NULL;
...
BOOL CPicoloVideoTriggerView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// CPicoloVideoTriggerView drawing

void CPicoloVideoTriggerView::OnDraw(CDC* pDC)
{
    CPicoloVideoTriggerDoc* pDoc = GetDocument();
    ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// CPicoloVideoTriggerView diagnostics

#ifdef _DEBUG
void CPicoloVideoTriggerView::AssertValid() const
{
    CView::AssertValid();
}

void CPicoloVideoTriggerView::Dump(CDumpContext& dc) const
{
    CView::Dump(dc);
}

CPicoloVideoTriggerDoc* CPicoloVideoTriggerView::GetDocument() // non-debug version is inline
{
    ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CPicoloVideoTriggerDoc)));
    return (CPicoloVideoTriggerDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// CPicoloVideoTriggerView message handlers

void CPicoloVideoTriggerView::OnInitialUpdate()
{
