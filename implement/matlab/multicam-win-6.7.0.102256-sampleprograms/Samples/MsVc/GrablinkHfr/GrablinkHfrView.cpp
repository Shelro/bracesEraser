...
// GrablinkHfrView.cpp : implementation of the CGrablinkHfrView class
//
...
IMPLEMENT_DYNCREATE(CGrablinkHfrView, CView)

BEGIN_MESSAGE_MAP(CGrablinkHfrView, CView)
    //{{AFX_MSG_MAP(CGrablinkHfrView)
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkHfrView construction/destruction

CGrablinkHfrView::CGrablinkHfrView()
{
    m_pMainFrame = NULL;
...
BOOL CGrablinkHfrView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkHfrView drawing

void CGrablinkHfrView::OnDraw(CDC* pDC)
{
    CGrablinkHfrDoc* pDoc = GetDocument();
    ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkHfrView diagnostics

#ifdef _DEBUG
void CGrablinkHfrView::AssertValid() const
{
    CView::AssertValid();
}

void CGrablinkHfrView::Dump(CDumpContext& dc) const
{
    CView::Dump(dc);
}

CGrablinkHfrDoc* CGrablinkHfrView::GetDocument() // non-debug version is inline
{
    ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CGrablinkHfrDoc)));
    return (CGrablinkHfrDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// CGrablinkHfrView message handlers

void CGrablinkHfrView::OnInitialUpdate()
{
