...
// MulticamAdvancedWaitSignalView.cpp : implementation of the CMulticamAdvancedWaitSignalView class
//
...
/////////////////////////////////////////////////////////////////////////////
// CMulticamAdvancedWaitSignalView

IMPLEMENT_DYNCREATE(CMulticamAdvancedWaitSignalView, CView)

BEGIN_MESSAGE_MAP(CMulticamAdvancedWaitSignalView, CView)
    //{{AFX_MSG_MAP(CMulticamAdvancedWaitSignalView)
...
/////////////////////////////////////////////////////////////////////////////
// CMulticamAdvancedWaitSignalView construction/destruction

CMulticamAdvancedWaitSignalView::CMulticamAdvancedWaitSignalView()
{
    m_pMainFrame = NULL;
...
BOOL CMulticamAdvancedWaitSignalView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// CMulticamAdvancedWaitSignalView drawing

void CMulticamAdvancedWaitSignalView::OnDraw(CDC* pDC)
{
    CMulticamAdvancedWaitSignalDoc* pDoc = GetDocument();
    ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// CMulticamAdvancedWaitSignalView diagnostics

#ifdef _DEBUG
void CMulticamAdvancedWaitSignalView::AssertValid() const
{
    CView::AssertValid();
}

void CMulticamAdvancedWaitSignalView::Dump(CDumpContext& dc) const
{
    CView::Dump(dc);
}

CMulticamAdvancedWaitSignalDoc* CMulticamAdvancedWaitSignalView::GetDocument() // non-debug version is inline
{
    ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CMulticamAdvancedWaitSignalDoc)));
    return (CMulticamAdvancedWaitSignalDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// CMulticamAdvancedWaitSignalView message handlers

void CMulticamAdvancedWaitSignalView::OnInitialUpdate()
{
