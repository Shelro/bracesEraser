...
// GrablinkHfrTriggerDoc.h : interface of the CGrablinkHfrTriggerDoc class
//
/////////////////////////////////////////////////////////////////////////////
...
class CGrablinkHfrTriggerDoc : public CDocument
{
...
protected: // create from serialization only
    ...
    DECLARE_DYNCREATE(CGrablinkHfrTriggerDoc)
...
// Overrides
    ...
    //{{AFX_VIRTUAL(CGrablinkHfrTriggerDoc)
public:
...
// Implementation
public:
    virtual ~CGrablinkHfrTriggerDoc();
#ifdef _DEBUG
...
protected:
    //{{AFX_MSG(CGrablinkHfrTriggerDoc)
    afx_msg void OnGo();
    afx_msg void OnStop();
    //}}AFX_MSG
    DECLARE_MESSAGE_MAP()
