...
// GrablinkHfrTrigger.h : main header file for the PROJECT1 application
//
...
// See GrablinkHfrTrigger.cpp for the implementation of this class
//

class CGrablinkHfrTriggerApp : public CWinApp
{
public:
    CGrablinkHfrTriggerApp();
...
// Overrides
    ...
    //{{AFX_VIRTUAL(CGrablinkHfrTriggerApp)
public:
...
// Implementation
    //{{AFX_MSG(CGrablinkHfrTriggerApp)
