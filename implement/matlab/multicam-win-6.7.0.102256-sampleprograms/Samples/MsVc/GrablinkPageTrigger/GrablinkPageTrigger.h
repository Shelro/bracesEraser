...
// GrablinkPageTrigger.h : main header file for the PROJECT1 application
//
...
// See GrablinkPageTrigger.cpp for the implementation of this class
//

class CGrablinkPageTriggerApp : public CWinApp
{
public:
    CGrablinkPageTriggerApp();
...
// Overrides
    ...
    //{{AFX_VIRTUAL(CGrablinkPageTriggerApp)
public:
...
// Implementation
    //{{AFX_MSG(CGrablinkPageTriggerApp)
