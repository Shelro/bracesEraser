...
// GrablinkPageTriggerDoc.h : interface of the CGrablinkPageTriggerDoc class
//
/////////////////////////////////////////////////////////////////////////////
...
class CGrablinkPageTriggerDoc : public CDocument
{
...
protected: // create from serialization only
    ...
    DECLARE_DYNCREATE(CGrablinkPageTriggerDoc)
...
// Overrides
    ...
    //{{AFX_VIRTUAL(CGrablinkPageTriggerDoc)
public:
...
// Implementation
public:
    virtual ~CGrablinkPageTriggerDoc();
#ifdef _DEBUG
...
protected:
    //{{AFX_MSG(CGrablinkPageTriggerDoc)
    afx_msg void OnGo();
    afx_msg void OnStop();
    //}}AFX_MSG
    DECLARE_MESSAGE_MAP()
