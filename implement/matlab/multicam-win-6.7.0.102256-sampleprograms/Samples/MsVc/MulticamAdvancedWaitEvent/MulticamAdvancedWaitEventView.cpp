...
// MulticamAdvancedWaitEventView.cpp : implementation of the CMulticamAdvancedWaitEventView class
//
...
/////////////////////////////////////////////////////////////////////////////
// CMulticamAdvancedWaitEventView

IMPLEMENT_DYNCREATE(CMulticamAdvancedWaitEventView, CView)

BEGIN_MESSAGE_MAP(CMulticamAdvancedWaitEventView, CView)
    //{{AFX_MSG_MAP(CMulticamAdvancedWaitEventView)
...
/////////////////////////////////////////////////////////////////////////////
// CMulticamAdvancedWaitEventView construction/destruction

CMulticamAdvancedWaitEventView::CMulticamAdvancedWaitEventView()
{
    m_pMainFrame = NULL;
...
BOOL CMulticamAdvancedWaitEventView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// CMulticamAdvancedWaitEventView drawing

void CMulticamAdvancedWaitEventView::OnDraw(CDC* pDC)
{
    CMulticamAdvancedWaitEventDoc* pDoc = GetDocument();
    ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// CMulticamAdvancedWaitEventView diagnostics

#ifdef _DEBUG
void CMulticamAdvancedWaitEventView::AssertValid() const
{
    CView::AssertValid();
}

void CMulticamAdvancedWaitEventView::Dump(CDumpContext& dc) const
{
    CView::Dump(dc);
}

CMulticamAdvancedWaitEventDoc* CMulticamAdvancedWaitEventView::GetDocument() // non-debug version is inline
{
    ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CMulticamAdvancedWaitEventDoc)));
    return (CMulticamAdvancedWaitEventDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// CMulticamAdvancedWaitEventView message handlers

void CMulticamAdvancedWaitEventView::OnInitialUpdate()
{
