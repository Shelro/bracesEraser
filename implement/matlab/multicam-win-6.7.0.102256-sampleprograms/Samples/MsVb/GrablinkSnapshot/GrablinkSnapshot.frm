...
Private Sub CreateMcChannel()
    ...
    ' CheckMcStatus McSetParamNmStr(BOARD + 0, "BoardTopology", "DUO")

    ' Set the board topology to support 10 taps mode (only with a Grablink Full)
    ' CheckMcStatus McSetParamNmStr(BOARD + 0, "BoardTopology", "MONO_DECA")
    ...
    CheckMcStatus McSetParamNmStr(gChannel, "Connector", "M")
    ' For Grablink Expert 2 and Dualbase
    ' CheckMcStatus McSetParamNmStr(gChannel, "Connector", "A")

    ' Choose the camera camfile
    CheckMcStatus McSetParamNmStr(gChannel, "CamFile", "1000m_P50RG")
    ' Choose the pixel color format
    CheckMcStatus McSetParamNmStr(gChannel, "ColorFormat", "Y8")

    ' Choose the acquisition mode
    CheckMcStatus McSetParamNmStr(gChannel, "AcquisitionMode", "SNAPSHOT")
