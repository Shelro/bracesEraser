...
// GrablinkHfrTriggerDoc.cpp : implementation of the CGrablinkHfrTriggerDoc class
//
#include "stdafx.h"
#include "GrablinkHfrTrigger.h"

#include "GrablinkHfrTriggerDoc.h"
#include "GrablinkHfrTriggerView.h"
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkHfrTriggerDoc

IMPLEMENT_DYNCREATE(CGrablinkHfrTriggerDoc, CDocument)

BEGIN_MESSAGE_MAP(CGrablinkHfrTriggerDoc, CDocument)
    //{{AFX_MSG_MAP(CGrablinkHfrTriggerDoc)
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkHfrTriggerDoc construction/destruction

CGrablinkHfrTriggerDoc::CGrablinkHfrTriggerDoc()
{
    m_Channel = 0;
    m_pCurrent = NULL;
    m_SizeX = 0;
...
BOOL CGrablinkHfrTriggerDoc::OnNewDocument()
{
    if (!CDocument::OnNewDocument())
        return FALSE;

    // + GrablinkHfrTrigger Sample Program
...
void WINAPI GlobalCallback(PMCSIGNALINFO SigInfo)
{
    ...
    {
        CGrablinkHfrTriggerDoc* pDoc = (CGrablinkHfrTriggerDoc*) SigInfo->Context;
...
void CGrablinkHfrTriggerDoc::Callback(PMCSIGNALINFO SigInfo)
{
    // + GrablinkHfrTrigger Sample Program
    ...
    switch(SigInfo->Signal)
    {
        case MC_SIG_SURFACE_PROCESSING:
            ...
            if(m_bScreenRefreshCompleted)
            {
                ...
                CGrablinkHfrTriggerView *pView = (CGrablinkHfrTriggerView *)GetNextView(pos);
        ...
        case MC_SIG_ACQUISITION_FAILURE:
            MessageBox(NULL, "Acquisition Failure !", "GrablinkHfrTrigger", MB_OK);
            break;
        default:
            break;
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkHfrTriggerDoc commands

void CGrablinkHfrTriggerDoc::OnGo()
{
    // + GrablinkHfrTrigger Sample Program
...
void CGrablinkHfrTriggerDoc::OnStop()
{
    // + GrablinkHfrTrigger Sample Program
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkHfrTriggerDoc serialization

void CGrablinkHfrTriggerDoc::Serialize(CArchive& ar)
{
}

/////////////////////////////////////////////////////////////////////////////
// CGrablinkHfrTriggerDoc diagnostics

#ifdef _DEBUG
void CGrablinkHfrTriggerDoc::AssertValid() const
{
    CDocument::AssertValid();
}

void CGrablinkHfrTriggerDoc::Dump(CDumpContext& dc) const
{
    CDocument::Dump(dc);
}
#endif //_DEBUG
