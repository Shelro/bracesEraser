...
// GrablinkHfrTriggerView.cpp : implementation of the CGrablinkHfrTriggerView class
//
...
IMPLEMENT_DYNCREATE(CGrablinkHfrTriggerView, CView)

BEGIN_MESSAGE_MAP(CGrablinkHfrTriggerView, CView)
    //{{AFX_MSG_MAP(CGrablinkHfrTriggerView)
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkHfrTriggerView construction/destruction

CGrablinkHfrTriggerView::CGrablinkHfrTriggerView()
{
    m_pMainFrame = NULL;
...
BOOL CGrablinkHfrTriggerView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkHfrTriggerView drawing

void CGrablinkHfrTriggerView::OnDraw(CDC* pDC)
{
    CGrablinkHfrTriggerDoc* pDoc = GetDocument();
    ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkHfrTriggerView diagnostics

#ifdef _DEBUG
void CGrablinkHfrTriggerView::AssertValid() const
{
    CView::AssertValid();
}

void CGrablinkHfrTriggerView::Dump(CDumpContext& dc) const
{
    CView::Dump(dc);
}

CGrablinkHfrTriggerDoc* CGrablinkHfrTriggerView::GetDocument() // non-debug version is inline
{
    ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CGrablinkHfrTriggerDoc)));
    return (CGrablinkHfrTriggerDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// CGrablinkHfrTriggerView message handlers

void CGrablinkHfrTriggerView::OnInitialUpdate()
{
