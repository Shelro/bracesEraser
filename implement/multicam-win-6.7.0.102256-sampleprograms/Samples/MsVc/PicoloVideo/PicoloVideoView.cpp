...
// PicoloVideoView.cpp : implementation of the CPicoloVideoView class
//
...
IMPLEMENT_DYNCREATE(CPicoloVideoView, CView)

BEGIN_MESSAGE_MAP(CPicoloVideoView, CView)
    //{{AFX_MSG_MAP(CPicoloVideoView)
...
/////////////////////////////////////////////////////////////////////////////
// CPicoloVideoView construction/destruction

CPicoloVideoView::CPicoloVideoView()
{
    m_pMainFrame = NULL;
...
BOOL CPicoloVideoView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// CPicoloVideoView drawing

void CPicoloVideoView::OnDraw(CDC* pDC)
{
    CPicoloVideoDoc* pDoc = GetDocument();
    ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// CPicoloVideoView diagnostics

#ifdef _DEBUG
void CPicoloVideoView::AssertValid() const
{
    CView::AssertValid();
}

void CPicoloVideoView::Dump(CDumpContext& dc) const
{
    CView::Dump(dc);
}

CPicoloVideoDoc* CPicoloVideoView::GetDocument() // non-debug version is inline
{
    ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CPicoloVideoDoc)));
    return (CPicoloVideoDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// CPicoloVideoView message handlers

void CPicoloVideoView::OnInitialUpdate()
{
