...
// GrablinkSnapshotTriggerView.cpp : implementation of the CGrablinkSnapshotTriggerView class
//
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkSnapshotTriggerView

IMPLEMENT_DYNCREATE(CGrablinkSnapshotTriggerView, CView)

BEGIN_MESSAGE_MAP(CGrablinkSnapshotTriggerView, CView)
    //{{AFX_MSG_MAP(CGrablinkSnapshotTriggerView)
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkSnapshotTriggerView construction/destruction

CGrablinkSnapshotTriggerView::CGrablinkSnapshotTriggerView()
{
    m_pMainFrame = NULL;
...
BOOL CGrablinkSnapshotTriggerView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkSnapshotTriggerView drawing

void CGrablinkSnapshotTriggerView::OnDraw(CDC* pDC)
{
    CGrablinkSnapshotTriggerDoc* pDoc = GetDocument();
    ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkSnapshotTriggerView diagnostics

#ifdef _DEBUG
void CGrablinkSnapshotTriggerView::AssertValid() const
{
    CView::AssertValid();
}

void CGrablinkSnapshotTriggerView::Dump(CDumpContext& dc) const
{
    CView::Dump(dc);
}

CGrablinkSnapshotTriggerDoc* CGrablinkSnapshotTriggerView::GetDocument() // non-debug version is inline
{
    ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CGrablinkSnapshotTriggerDoc)));
    return (CGrablinkSnapshotTriggerDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// CGrablinkSnapshotTriggerView message handlers

void CGrablinkSnapshotTriggerView::OnInitialUpdate()
{
