...
// GrablinkWebView.cpp : implementation of the CGrablinkWebView class
//
...
IMPLEMENT_DYNCREATE(CGrablinkWebView, CView)

BEGIN_MESSAGE_MAP(CGrablinkWebView, CView)
    //{{AFX_MSG_MAP(CGrablinkWebView)
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkWebView construction/destruction

CGrablinkWebView::CGrablinkWebView()
{
    m_pMainFrame = NULL;
...
BOOL CGrablinkWebView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkWebView drawing

void CGrablinkWebView::OnDraw(CDC* pDC)
{
    CGrablinkWebDoc* pDoc = GetDocument();
    ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// CGrablinkWebView diagnostics

#ifdef _DEBUG
void CGrablinkWebView::AssertValid() const
{
    CView::AssertValid();
}

void CGrablinkWebView::Dump(CDumpContext& dc) const
{
    CView::Dump(dc);
}

CGrablinkWebDoc* CGrablinkWebView::GetDocument() // non-debug version is inline
{
    ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CGrablinkWebDoc)));
    return (CGrablinkWebDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// CGrablinkWebView message handlers

void CGrablinkWebView::OnInitialUpdate()
{
