...
// DominoSnapshotView.cpp : implementation of the CDominoSnapshotView class
//
...
IMPLEMENT_DYNCREATE(CDominoSnapshotView, CView)

BEGIN_MESSAGE_MAP(CDominoSnapshotView, CView)
    //{{AFX_MSG_MAP(CDominoSnapshotView)
...
/////////////////////////////////////////////////////////////////////////////
// CDominoSnapshotView construction/destruction

CDominoSnapshotView::CDominoSnapshotView()
{
    m_pMainFrame = NULL;
...
BOOL CDominoSnapshotView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// CDominoSnapshotView drawing

void CDominoSnapshotView::OnDraw(CDC* pDC)
{
    CDominoSnapshotDoc* pDoc = GetDocument();
    ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// CDominoSnapshotView diagnostics

#ifdef _DEBUG
void CDominoSnapshotView::AssertValid() const
{
    CView::AssertValid();
}

void CDominoSnapshotView::Dump(CDumpContext& dc) const
{
    CView::Dump(dc);
}

CDominoSnapshotDoc* CDominoSnapshotView::GetDocument() // non-debug version is inline
{
    ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CDominoSnapshotDoc)));
    return (CDominoSnapshotDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// CDominoSnapshotView message handlers

void CDominoSnapshotView::OnInitialUpdate()
{
