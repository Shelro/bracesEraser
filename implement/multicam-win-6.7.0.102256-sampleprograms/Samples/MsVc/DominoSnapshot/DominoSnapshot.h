...
// DominoSnapshot.h : main header file for the PROJECT1 application
//
...
/////////////////////////////////////////////////////////////////////////////
// CDominoSnapshotApp:
// See DominoSnapshot.cpp for the implementation of this class
//

class CDominoSnapshotApp : public CWinApp
{
public:
    CDominoSnapshotApp();
...
// Overrides
    ...
    //{{AFX_VIRTUAL(CDominoSnapshotApp)
public:
