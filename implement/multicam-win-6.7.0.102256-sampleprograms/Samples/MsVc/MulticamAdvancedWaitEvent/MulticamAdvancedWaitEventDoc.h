...
// MulticamAdvancedWaitEventDoc.h : interface of the CMulticamAdvancedWaitEventDoc class
//
/////////////////////////////////////////////////////////////////////////////
...
class CMulticamAdvancedWaitEventDoc : public CDocument
{
...
protected: // create from serialization only
    ...
    DECLARE_DYNCREATE(CMulticamAdvancedWaitEventDoc)
...
// Overrides
    ...
    //{{AFX_VIRTUAL(CMulticamAdvancedWaitEventDoc)
public:
...
// Implementation
public:
    virtual ~CMulticamAdvancedWaitEventDoc();
#ifdef _DEBUG
...
protected:
    //{{AFX_MSG(CMulticamAdvancedWaitEventDoc)
    afx_msg void OnGo();
    afx_msg void OnStop();
    //}}AFX_MSG
    DECLARE_MESSAGE_MAP()
