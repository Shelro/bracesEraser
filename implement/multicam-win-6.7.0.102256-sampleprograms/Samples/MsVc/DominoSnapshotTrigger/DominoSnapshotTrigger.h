...
// DominoSnapshotTrigger.h : main header file for the PROJECT1 application
//
...
// See DominoSnapshotTrigger.cpp for the implementation of this class
//

class CDominoSnapshotTriggerApp : public CWinApp
{
public:
    CDominoSnapshotTriggerApp();
...
// Overrides
    ...
    //{{AFX_VIRTUAL(CDominoSnapshotTriggerApp)
public:
...
// Implementation
    //{{AFX_MSG(CDominoSnapshotTriggerApp)
