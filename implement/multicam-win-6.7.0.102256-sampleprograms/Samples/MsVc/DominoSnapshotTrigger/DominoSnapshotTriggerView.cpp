...
// DominoSnapshotTriggerView.cpp : implementation of the CDominoSnapshotTriggerView class
//
...
/////////////////////////////////////////////////////////////////////////////
// CDominoSnapshotTriggerView

IMPLEMENT_DYNCREATE(CDominoSnapshotTriggerView, CView)

BEGIN_MESSAGE_MAP(CDominoSnapshotTriggerView, CView)
    //{{AFX_MSG_MAP(CDominoSnapshotTriggerView)
...
/////////////////////////////////////////////////////////////////////////////
// CDominoSnapshotTriggerView construction/destruction

CDominoSnapshotTriggerView::CDominoSnapshotTriggerView()
{
    m_pMainFrame = NULL;
...
BOOL CDominoSnapshotTriggerView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// CDominoSnapshotTriggerView drawing

void CDominoSnapshotTriggerView::OnDraw(CDC* pDC)
{
    CDominoSnapshotTriggerDoc* pDoc = GetDocument();
    ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// CDominoSnapshotTriggerView diagnostics

#ifdef _DEBUG
void CDominoSnapshotTriggerView::AssertValid() const
{
    CView::AssertValid();
}

void CDominoSnapshotTriggerView::Dump(CDumpContext& dc) const
{
    CView::Dump(dc);
}

CDominoSnapshotTriggerDoc* CDominoSnapshotTriggerView::GetDocument() // non-debug version is inline
{
    ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CDominoSnapshotTriggerDoc)));
    return (CDominoSnapshotTriggerDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// CDominoSnapshotTriggerView message handlers

void CDominoSnapshotTriggerView::OnInitialUpdate()
{
