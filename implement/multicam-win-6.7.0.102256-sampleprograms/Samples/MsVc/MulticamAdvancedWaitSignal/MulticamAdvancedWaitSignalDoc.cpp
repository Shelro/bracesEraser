...
// MulticamAdvancedWaitSignalDoc.cpp : implementation of the CMulticamAdvancedWaitSignalDoc class
//
#include "stdafx.h"
#include "MulticamAdvancedWaitSignal.h"

#include "MulticamAdvancedWaitSignalDoc.h"
#include "MulticamAdvancedWaitSignalView.h"
...
IMPLEMENT_DYNCREATE(CMulticamAdvancedWaitSignalDoc, CDocument)

BEGIN_MESSAGE_MAP(CMulticamAdvancedWaitSignalDoc, CDocument)
    //{{AFX_MSG_MAP(CMulticamAdvancedWaitSignalDoc)
...
/////////////////////////////////////////////////////////////////////////////
// CMulticamAdvancedWaitSignalDoc construction/destruction

CMulticamAdvancedWaitSignalDoc::CMulticamAdvancedWaitSignalDoc()
{
    m_Channel = 0;
    m_pCurrent = NULL;
    m_SizeX = 0;
...
BOOL CMulticamAdvancedWaitSignalDoc::OnNewDocument()
{
    ...
    McSetParamInt(m_Channel, MC_SignalHandling + MC_SIG_SURFACE_FILLED, MC_SignalHandling_WAITING_SIGNALING);
    McSetParamInt(m_Channel, MC_SignalHandling + MC_SIG_ACQUISITION_FAILURE, MC_SignalHandling_WAITING_SIGNALING);
    McSetParamInt(m_Channel, MC_SignalHandling + MC_SIG_END_CHANNEL_ACTIVITY, MC_SignalHandling_WAITING_SIGNALING);
...
UINT LiveThreadProc( LPVOID Param ) //Sample function for using in AfxBeginThread
{
	...
	CMulticamAdvancedWaitSignalDoc* pDoc = (CMulticamAdvancedWaitSignalDoc*) Param;
	MCSIGNALINFO sigInfo ;

	while(pDoc->m_RunLoop)
	{
		//Get Signal Information
		if(McWaitSignal(pDoc->m_Channel,MC_SIG_ANY, 1000, &sigInfo )== MC_OK)
...
void CMulticamAdvancedWaitSignalDoc::HandleSignal(PMCSIGNALINFO SigInfo)
{
    ...
    switch(SigInfo->Signal)
    {
        ...
        case MC_SIG_SURFACE_FILLED:
            ...
            if(m_bScreenRefreshCompleted)
            {
                ...
                CMulticamAdvancedWaitSignalView *pView = (CMulticamAdvancedWaitSignalView *)GetNextView(pos);
...
/////////////////////////////////////////////////////////////////////////////
// CMulticamAdvancedWaitSignalDoc commands

void CMulticamAdvancedWaitSignalDoc::OnGo()
{
    // + MulticamAdvancedWaitSignal Sample Program
...
void CMulticamAdvancedWaitSignalDoc::OnStop()
{
    // + MulticamAdvancedWaitSignal Sample Program
...
/////////////////////////////////////////////////////////////////////////////
// CMulticamAdvancedWaitSignalDoc serialization

void CMulticamAdvancedWaitSignalDoc::Serialize(CArchive& ar)
{
}

/////////////////////////////////////////////////////////////////////////////
// CMulticamAdvancedWaitSignalDoc diagnostics

#ifdef _DEBUG
void CMulticamAdvancedWaitSignalDoc::AssertValid() const
{
    CDocument::AssertValid();
}

void CMulticamAdvancedWaitSignalDoc::Dump(CDumpContext& dc) const
{
    CDocument::Dump(dc);
}
#endif //_DEBUG
