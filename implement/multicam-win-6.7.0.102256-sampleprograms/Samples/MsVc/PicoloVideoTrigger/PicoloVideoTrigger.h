...
// PicoloVideoTrigger.h : main header file for the PROJECT1 application
//
...
// See PicoloVideoTrigger.cpp for the implementation of this class
//

class CPicoloVideoTriggerApp : public CWinApp
{
public:
    CPicoloVideoTriggerApp();
...
// Overrides
    ...
    //{{AFX_VIRTUAL(CPicoloVideoTriggerApp)
public:
...
// Implementation
    //{{AFX_MSG(CPicoloVideoTriggerApp)
