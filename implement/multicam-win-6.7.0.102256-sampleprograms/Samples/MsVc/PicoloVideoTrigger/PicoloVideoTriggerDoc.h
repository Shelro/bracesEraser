...
// PicoloVideoTriggerDoc.h : interface of the CPicoloVideoTriggerDoc class
//
/////////////////////////////////////////////////////////////////////////////
...
class CPicoloVideoTriggerDoc : public CDocument
{
...
protected: // create from serialization only
    ...
    DECLARE_DYNCREATE(CPicoloVideoTriggerDoc)
...
// Overrides
    ...
    //{{AFX_VIRTUAL(CPicoloVideoTriggerDoc)
public:
...
// Implementation
public:
    virtual ~CPicoloVideoTriggerDoc();
#ifdef _DEBUG
...
protected:
    //{{AFX_MSG(CPicoloVideoTriggerDoc)
    afx_msg void OnGo();
    afx_msg void OnStop();
    //}}AFX_MSG
    DECLARE_MESSAGE_MAP()
