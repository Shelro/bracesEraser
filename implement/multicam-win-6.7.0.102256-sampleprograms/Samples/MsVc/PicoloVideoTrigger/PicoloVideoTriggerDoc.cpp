...
// PicoloVideoTriggerDoc.cpp : implementation of the CPicoloVideoTriggerDoc class
//
#include "stdafx.h"
#include "PicoloVideoTrigger.h"

#include "PicoloVideoTriggerDoc.h"
#include "PicoloVideoTriggerView.h"
...
/////////////////////////////////////////////////////////////////////////////
// CPicoloVideoTriggerDoc

IMPLEMENT_DYNCREATE(CPicoloVideoTriggerDoc, CDocument)

BEGIN_MESSAGE_MAP(CPicoloVideoTriggerDoc, CDocument)
    //{{AFX_MSG_MAP(CPicoloVideoTriggerDoc)
...
/////////////////////////////////////////////////////////////////////////////
// CPicoloVideoTriggerDoc construction/destruction

CPicoloVideoTriggerDoc::CPicoloVideoTriggerDoc()
{
    m_Channel = 0;
    m_pCurrent = NULL;
    m_SizeX = 0;
...
BOOL CPicoloVideoTriggerDoc::OnNewDocument()
{
    ...
    McSetParamInt(m_Channel, MC_ActivityLength, MC_INDETERMINATE);
    // Choose the number of images to acquire
    McSetParamInt(m_Channel, MC_SeqLength_Fr, 100);
    McSetParamInt(m_Channel, MC_TrigLineIndex, 1);
    McSetParamInt(m_Channel, MC_TrigEdge, MC_TrigEdge_GOLOW);
...
void WINAPI GlobalCallback(PMCSIGNALINFO SigInfo)
{
    ...
    {
        CPicoloVideoTriggerDoc* pDoc = (CPicoloVideoTriggerDoc*) SigInfo->Context;
...
void CPicoloVideoTriggerDoc::Callback(PMCSIGNALINFO SigInfo)
{
    // + PicoloVideoTrigger Sample Program
    ...
    switch(SigInfo->Signal)
    {
        case MC_SIG_SURFACE_PROCESSING:
            ...
            if(m_bScreenRefreshCompleted)
            {
                ...
                CPicoloVideoTriggerView *pView = (CPicoloVideoTriggerView *)GetNextView(pos);
...
/////////////////////////////////////////////////////////////////////////////
// CPicoloVideoTriggerDoc commands

void CPicoloVideoTriggerDoc::OnGo()
{
    // + PicoloVideoTrigger Sample Program
...
void CPicoloVideoTriggerDoc::OnStop()
{
    // + PicoloVideoTrigger Sample Program
...
/////////////////////////////////////////////////////////////////////////////
// CPicoloVideoTriggerDoc serialization

void CPicoloVideoTriggerDoc::Serialize(CArchive& ar)
{
}

/////////////////////////////////////////////////////////////////////////////
// CPicoloVideoTriggerDoc diagnostics

#ifdef _DEBUG
void CPicoloVideoTriggerDoc::AssertValid() const
{
    CDocument::AssertValid();
}

void CPicoloVideoTriggerDoc::Dump(CDumpContext& dc) const
{
    CDocument::Dump(dc);
}
#endif //_DEBUG
